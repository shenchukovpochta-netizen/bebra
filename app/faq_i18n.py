...
LANGS: tuple[str, ...] = ("ru", "en", "uz", "tk", "tt", "ar", "fa", "hi", "cv")
...
"tt": {
    "pick": "Телне сайлагыз:",
    "menu": "Сорауны сайлагыз — шунда ук җавап бирәм.",
    "contact": "Безгә языгыз: " + CONTACT,
    "change": "🌐 Телне алыштыру",
    "after_hours": "Хәзер пунктлар ябык — 10:00 дән соң килегез; без көн саен 19:00 гә кадәр эшлибез.",
    "handoff": "Тәфсилләп бер хәбәрдә языгыз — менеджерга тапшырам.\nФикерегез үзгәрсә — «Отмена» басыгыз.",
    "your_rate": "Сезнең тариф (шартнамә буенча): {plan}.",
    "week": "атна",
    "weeks2": "2 атна",
    "month": "ай",
    "price_head": "💰 Аренда бәяләре (2 АКБ һәм корылма кертелгән):",
    "price_ext": "Килешенгән вакыттан соң озайту — тәүлегенә 650 ₽ (шартнамә буенча).",
    "price_incl": "Тарифка керә: чиратсыз ремонт, ватылганда бер көн эчендә алмаш велосипед, GPS-саклау һәм безнең хисапка техник хезмәт күрсәтү. Залог юк.",
    "price_next": "Аренда алу өчен безгә языгыз: " + CONTACT,
    "t_ADDR": "Адреслар, ничек барып җитәргә",
    "t_HOURS": "Эш вакыты",
    "t_PRICE": "Аренда бәяләре",
    "t_PAY": "Түләү һәм чек",
    "t_BATT_Q": "АКБ: ничә километрга җитә",
    "t_BATT_SWAP": "АКБ алыштыру",
    "t_BATT_3": "Өченче АКБ",
    "t_RETURN": "Велосипедны тапшыру",
    "t_RENEW": "Арендәне озайту",
    "t_LEAD": "Аренда алырга телим",
    "t_DOCS": "Документлар, залог",
    "t_BRK_MECH": "Велосипед ватылды",
    "t_PICKUP": "Велосипедны алып китү",
    "t_EXT_REP": "Үз техникагызны ремонтлау",
    "t_REP_STATUS": "Ремонт ничек бара",
    "t_BUYOUT": "Велосипедны сатып алу",
    "a_ADDR": "Казанда безнең ике пункт бар:\n📍 Адоратский урамы, 11А\n📍 Павлюхин урамы, 97А — «Сокол» ГСК, 9 нчы бокс\nИкесе дә көн саен 10:00 дән 19:00 гә кадәр, ялсыз эшли.\nПавлюхинда «Сокол» ГСК эченә керәсез, 9 нчы боксны эзләгез — тапмасагыз, языгыз, каршы алабыз.\nСезгә кайсы пункт уңайлырак?",
    "a_HOURS": "Көн саен 10:00 дән 19:00 гә кадәр, ялсыз эшлибез — ике пункт та:\n📍 Адоратский урамы, 11А\n📍 Павлюхин урамы, 97А — «Сокол» ГСК, 9 нчы бокс\nТеләсә кайсы көнне килегез.",
    "a_PAY": "Түләү түбәндәге сылтама аша — бу безнең бердәнбер хисап счёты 👇\n{pay_url}\nТүләгәннән соң чекны шушы чатка җибәрегез.",
    "a_BATT_Q": "Чыгым тизлеккә нык бәйле: 3 нче тизлектә батарея берничә сәгатьтә бетә — бу гадәти хәл, анда чыгым берничә тапкыр күбрәк. 1–2 тизлектә ике АКБ 50 км тирәсе җитә.\nЭш батареяләрдә дип уйласагыз — теләсә кайсы пунктка китерегез, йөкләмә астында тикшерәбез һәм кирәк булса алыштырабыз. Бушлай.",
    "a_BATT_SWAP": "АКБ алыштыруны ике пунктта да, көн саен 10:00–19:00, ялсыз башкарабыз.\nКорылган АКБ барлыгын пункт администраторыннан ачыклыйм — кайсы пунктка барачагыгызны языгыз, җавап белән кайтам.",
    "a_BATT_3": "Өченче аккумуляторны тарифтан тыш өстәмә арендага бирәбез — бәясен менеджердан ачыклыйм.\nНичә вакытка кирәклеген языгыз, сорауны тапшырам.",
    "a_RETURN": "Велосипедны теләсә кайсы көнне, 10:00–19:00, ялсыз, теләсә кайсы пунктта кабул итә алабыз — кайчан килүегез турында алдан хәбәр итегез.\nАкча ягыннан бер мәсьәлә: велосипед сезгә түләнгән бөтен вакытка беркетелә, шуңа күрә йөрелмәгән көннәр өчен исәпләү ясалмый һәм алар киләсе чорга күчерелми.",
    "a_RENEW": "Озайту онлайн рәвештә мөмкин, килергә кирәкми — сылтама аша түләгез һәм чекны җибәрегез:\n{pay_url}\nОзайту өчен түләү озайту көнендә бер сумма белән түләнә.",
    "a_LEAD": "Әйе, курьерлар өчен электровелосипедлар бар — Truck+ һәм Kugoo V3 Pro, барысы да 2 АКБ, корылма һәм телефон тоткычы белән. Залог юк, паспорт буенча рәсмиләштерәбез.\nПунктлар:\n📍 Адоратский урамы, 11А\n📍 Павлюхин урамы, 97А — «Сокол» ГСК, 9 нчы бокс\nӘйтегез әле: ничә вакытка планлаштырасыз һәм кайсы пунктка килү уңайлырак?",
    "a_DOCS": "Залог юк 🤝 Документлардан:\n— РФ гражданнары — паспорт;\n— башка дәүләт гражданнары — милли паспорт, вакытлыча теркәлү һәм миграция карточкасы.\nШартнамә нәкъ шушында, ботта имзалана: гариза тикшерелгәннән соң ул сезгә имзага килә.",
    "a_BRK_MECH": "Аңладым, хәл итәрбез. Зинһар, кыска видео төшерегез — велосипед үзен ничек тота, нәрсә эшләми һәм дисплейда нәрсә яна. Һәм кайсы пунктка килү якынрак икәнен әйтегез:\n📍 Адоратский урамы, 11А\n📍 Павлюхин урамы, 97А — «Сокол» ГСК, 9 нчы бокс\nАрендаторлар өчен ремонт чиратсыз, ә эш бер көннән артыкка сузылса — алмаш велосипед бирәбез.",
    "a_PICKUP": "Чыгып йөрүче остабыз юк — ремонтны пунктларда башкарабыз. Ләкин велосипед бармый торган булса, килешү буенча аны машина белән алып китә алабыз, хезмәт түләүле.\nАдресыгызны языгыз — менеджерга тапшырам, вакытын һәм бәясен килешербез.",
