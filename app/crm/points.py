...
название, адрес, режим и телефон. Описание и координаты сюда не едут -
описание пишут для своих, а не для курьера.
...
FIELDS: tuple[str, ...] = ("name", "public_title", "address", "hours", "phone")
