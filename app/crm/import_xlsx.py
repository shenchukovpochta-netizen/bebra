...
COLUMNS = {
    ...
    # «Имя» и «ФИО» - одна и та же колонка в разных редакциях таблицы.
    # Без этого совпадения импорт заводил парк и молча не заводил ни
    # одного клиента: строка без ФИО считается строкой без арендатора.
    "фио": "fio", "имя": "fio", "фиоарендатора": "fio", "имяарендатора": "fio",
    "фиоклиента": "fio",
