...
T: dict[str, str] = {
    ...
    # ── кабинет клиента (CRM) ──
    "CAB_UNAVAILABLE": 'Shaxsiy kabinet vaqtincha ishlamayapti. Bizga yozing: ' + URL,
    "CAB_LINK_PROMPT": "Assalomu alaykum! Pastdagi tugmani bosing — akkauntingizni shaxsiy kabinetga bog'layman.",
    "CAB_NOT_FOUND": '⚠️ Raqamingiz tizimda topilmadi.\nMenejerga murojaat qiling: {url}',
    "CAB_LINKED": "✅ Akkaunt bog'landi: {name}.",
    "CAB_BLOCKED": 'Shaxsiy kabinet mavjud emas. Menejerga murojaat qiling: {url}',
    "CAB_HOME": '🚲 <b>Mening kabinetim</b>\n\n👤 {name}\n💰 Balans: <b>{balance}</b>\n{rental}\n\n{hint}',
    "CAB_RENTAL": "🛵 Velosiped: {bike}\n📋 Tarif: {tariff} — {price} / {days} kun\n📅 To'langan muddat: <b>{until}</b> ({left})",
    "CAB_NO_RENTAL": "Faol ijara yo'q.",
    "CAB_LEFT_DAYS": 'qolgan kunlar: {days}',
    "CAB_LEFT_TODAY": "to'lov bugun",
    "CAB_OVERDUE": '⚠️ {days} kun kechikish, qarz {debt}',
    "CAB_HINT_DEBT": "Ijara uzilishsiz davom etishi uchun balansni {amount} ga to'ldiring.",
    "CAB_HINT_OK": "Balansni oldindan to'ldirish mumkin — summa keyingi davrga hisoblanadi.",
    "CAB_PAY": "💳 <b>Balansni to'ldirish</b>\n\nTavsiya etilgan summa: <b>{amount}</b>\nHavola orqali to'lov (SBP): {pay_url}\n\nO'tkazmadan so'ng «To'ladim» tugmasini bosing — operator tushumni tekshirib, balansga o'tkazadi. Chekni shu yerga rasm qilib yuborishingiz mumkin.",
    "CAB_PAY_PICK": "💳 <b>Balansni to'ldirish</b>\n\nBalans: <b>{balance}</b>\n{hint}\n\nSummani tanlang:",
    "CAB_PAY_NOTHING": "Faol ijara ham, qarz ham yo'q — to'ldiradigan narsa yo'q. Velosiped kerakmi? Bizga yozing: {url}",
    "CAB_PAY_STALE": "Summa o'zgardi, to'ldirishni qaytadan oching.",
    "CAB_PAY_ORDER": "💳 {no} hisob, <b>{amount}</b>.\nTugma orqali to'lang — chekni bank yuboradi, pul bir daqiqada balansga o'zi tushadi.\nTugma ochilmasa: {link}",
    "CAB_PAY_PENDING": "Bank to'lovni hali tasdiqlamadi. Bir daqiqadan keyin tekshiring.",
    "CAB_PAY_DONE": "✅ {no} hisob to'landi: {amount} balansda. Balans: {balance}.",
    "CAB_PAY_FAILED": "{no} hisob to'lovsiz yopildi. To'ldirishni qaytadan oching.",
    "CAB_OPT_DEBT": 'Qarz — {amount}',
    "CAB_OPT_PERIOD": '{n} × {days} kun — {amount}',
    "CAB_INTENT_RENEW": "Yozib oldik: uzaytirasiz. To'lov haqida oldindan eslatamiz.",
    "CAB_INTENT_RETURN": 'Yozib oldik: {until} topshirasiz. Nuqtada kutamiz — velosipedni zaryadlangan holda olib keling.',
    ...
    "CAB_BOOK_NO_MODELS": "Modellar katalogi hali to'ldirilmagan — bizga yozing: {url}",
    "CAB_BOOK_NO_TARIFF": "Bu model uchun hali narx yo'q — bizga yozing: {url}",
    "CAB_BOOK_STALE": "Tugma eskirgan, so'rovni qaytadan boshlang.",
    "CAB_BOOK_CANCELLED": "So'rov olib tashlandi. Yana kerak bo'lsa — tugma kabinetda.",
    "CAB_BOOK_REMOVED": "Ijaraga so'rovni ({line}) operator bekor qildi.{note}\nSavollar — bizga yozing: {url}",
    "CAB_BOOK_LINE": "📝 So'rov: {line}",
    "CAB_BOOK_OPT_MODEL": "{title} — bo'sh {free}",
    "CAB_BOOK_OPT_MODEL_NONE": '{title} — navbatga',
    "CAB_BOOK_OPT_TARIFF": '{name} — {price}',
    "CAB_BOOK_TODAY": 'Bugun, {date}',
    "CAB_BOOK_TOMORROW": 'Ertaga, {date}',
    "CAB_BOOK_DAY2": 'Indinga, {date}',
    "CAB_CLAIM_TOAST": "So'rov yuborildi",
    "CAB_CLAIM_SENT": "✅ So'rov operatorga yetkazildi. To'lov o'tkazilishi bilan yozaman.\nChekni shu yerga yuborishingiz mumkin — so'rovga biriktiraman.",
    "CAB_CLAIM_EXISTS": "So'rov allaqachon operatorda tekshirilmoqda. O'tkazilishini kuting.",
    "CAB_RECEIPT_ATTACHED": "Chek so'rovga biriktirildi.",
    "CAB_HISTORY": '🧾 <b>Operatsiyalar tarixi</b>\n\n{rows}',
    "CAB_HISTORY_EMPTY": "Hozircha operatsiyalar yo'q.",
    "CAB_KIND_PAYMENT": "to'lov",
    "CAB_KIND_CHARGE": 'hisoblash',
    "CAB_KIND_FINE": "jarima / ta'mir",
    "CAB_KIND_REFUND": 'qaytarish',
    "CAB_KIND_ADJUST": 'tuzatish',
    "CAB_KIND_BONUS": 'ballar',
    "CAB_CONTRACT_NONE": "Shartnoma hali rasmiylashtirilmagan. Botda imzolangach shu yerda paydo bo'ladi.",
    "CAB_CONTRACT_CAPTION": '📄 Sizning shartnomangiz № {number}',
    "CAB_PAID_CONFIRMED": "✅ {amount} to'lov o'tkazildi. Balans: {balance}.\n{rental}",
    "CAB_PAID_UNTIL": "To'langan muddat: {until}.",
    "CAB_PAID_REJECTED": "❌ Operator to'lovingizni topmadi. Rekvizitlarni tekshiring va bizga yozing: {url}",
    "CAB_REMIND_SOON": "📅 <b>{bike}</b> ijarasining to'langan davri {until} tugaydi. Qolgan kunlar: {days}.\nBalansni {amount} ga to'ldiring — ijara uzilishsiz davom etadi.",
    "CAB_REMIND_DUE": "📅 Bugun <b>{bike}</b> ijarasi uchun to'lov kuni: {amount}.\nBalansni to'ldiring — pastdagi tugma.",
    "CAB_REMIND_OVERDUE": "⚠️ <b>{bike}</b> ijarasi {until} dan beri to'lanmagan. Qarz: {debt}.\nIltimos, balansni to'ldiring yoki velosipedni topshiring — haq hisoblanaveradi.",
    "CAB_RENTAL_OPENED": "🚲 Ijara rasmiylashtirildi: {bike}, «{tariff}» tarifi ({price} / {days} kun).\nTo'langan muddat: {until}. Balans: {balance}.",
    "CAB_RENTAL_CLOSED": '{bike} ijarasi yopildi. Balans: {balance}. Rahmat!',
    "BTN_CAB_FRIENDS": "👥 Do'stlarim",
    "BTN_CAB_REVIEW": "⭐ Sharh qoldirish",
    "CAB_FRIENDS": "👥 <b>Do'stlarim</b>\n\nTaklif kodingiz: <code>{code}</code>\nHavola: {link}\n\nUni velosiped qidirayotgan kuryerga yuboring. Do'stingiz ijara rasmiylashtirib, birinchi to'lovni qilganda, balansingizga <b>{bonus}</b> qo'shiladi.\n\n{stats}",
    "CAB_FRIENDS_STATS": "Havola bo'ylab o'tganlar: {click}\nRo'yxatdan o'tganlar: {signed}\nVelosiped olganlar: {rented}\nTo'laganlar: {paid}\nSizga qo'shildi: <b>{bonus}</b>",
    "CAB_FRIENDS_EMPTY": 'Hozircha havolangiz orqali hech kim kelmadi.',
    "CAB_FRIENDS_OFF": "👥 <b>Do'stlarim</b>\n\nTaklif dasturi hozir o'chirilgan.",
    "CAB_REF_BONUS": "🎁 Do'stingiz {name} ijara rasmiylashtirdi va birinchi to'lovni qildi.\n{amount} bonus balansingizga qo'shildi. Rahmat!",
    "CAB_PROMO_APPLIED": "🎉 «{title}» aksiyasi: sizga {amount} ball qo'shildi.\nBalans: {balance}.{text}",
    "BTN_CABINET": '🚲 Mening kabinetim',
    "BTN_CAB_TOPUP": "💳 Balansni to'ldirish",
    "BTN_CAB_HISTORY": '🧾 Tarix',
    "BTN_CAB_CONTRACT": '📄 Shartnoma',
    "BTN_CAB_REFRESH": '🔄 Yangilash',
    "BTN_CAB_BACK": '◀️ Orqaga',
    "BTN_PAY_CHECK": "🔄 To'lovni tekshirish",
    "BTN_BOOK": '🚲 Velosiped bron qilish',
    "BTN_BOOK_CANCEL": "❌ So'rovni olib tashlash",
