...
T: dict[str, str] = {
    ...
    # ── кабинет клиента (CRM) ──
    "CAB_UNAVAILABLE": 'Şahsy otag wagtlaýyn elýeterli däl. Bize ýazyň: ' + URL,
    "CAB_LINK_PROMPT": 'Salam! Aşakdaky düwmä basyň — hasabyňyzy şahsy otaga baglaýaryn.',
    "CAB_NOT_FOUND": '⚠️ Belgiňiz ulgamda tapylmady.\nMenejere ýüz tutuň: {url}',
    "CAB_LINKED": '✅ Hasap baglandy: {name}.',
    "CAB_BLOCKED": 'Şahsy otag elýeterli däl. Menejere ýüz tutuň: {url}',
    "CAB_HOME": '🚲 <b>Meniň otagym</b>\n\n👤 {name}\n💰 Balans: <b>{balance}</b>\n{rental}\n\n{hint}',
    "CAB_RENTAL": '🛵 Welosiped: {bike}\n📋 Tarif: {tariff} — {price} / {days} gün\n📅 Tölenen möhlet: <b>{until}</b> ({left})',
    "CAB_NO_RENTAL": 'Işjeň kärende ýok.',
    "CAB_LEFT_DAYS": 'galan günler: {days}',
    "CAB_LEFT_TODAY": 'töleg şu gün',
    "CAB_OVERDUE": '⚠️ {days} gün gijikme, bergi {debt}',
    "CAB_HINT_DEBT": 'Kärende arasy kesilmän dowam etmegi üçin balansy {amount} möçberde dolduryň.',
    "CAB_HINT_OK": 'Balansy öňünden doldurmak bolýar — möçber indiki döwre hasaplanar.',
    "CAB_PAY": '💳 <b>Balansy doldurmak</b>\n\nMaslahat berilýän möçber: <b>{amount}</b>\nSalgy boýunça töleg (SBP): {pay_url}\n\nGeçirimden soň «Töledim» düwmesine basyň — operator gelen puly barlap, balansa geçirer. Çegi şu ýere surat görnüşinde iberip bilersiňiz.',
    "CAB_PAY_PICK": '💳 <b>Balansy doldurmak</b>\n\nBalans: <b>{balance}</b>\n{hint}\n\nMöçberi saýlaň:',
    "CAB_PAY_NOTHING": 'Işjeň kärende-de, bergi-de ýok — doldurar ýaly zat ýok. Welosiped gerekmi? Bize ýazyň: {url}',
    "CAB_PAY_STALE": 'Möçber üýtgedi, doldurmagy täzeden açyň.',
    "CAB_PAY_ORDER": '💳 {no} hasap, <b>{amount}</b>.\nDüwme arkaly töläň — çegi bank iberer, pul bir minutda balansa özi geçer.\nDüwme açylmasa: {link}',
    "CAB_PAY_PENDING": 'Bank tölegi entek tassyklamady. Bir minutdan barlaň.',
    "CAB_PAY_DONE": '✅ {no} hasap tölendi: {amount} balansda. Balans: {balance}.',
    "CAB_PAY_FAILED": '{no} hasap tölegsiz ýapyldy. Doldurmagy täzeden açyň.',
    "CAB_OPT_DEBT": 'Bergi — {amount}',
    "CAB_OPT_PERIOD": '{n} × {days} gün — {amount}',
    "CAB_INTENT_RENEW": 'Ýazdyk: uzaldýarsyňyz. Töleg barada öňünden ýatladarys.',
    "CAB_INTENT_RETURN": 'Ýazdyk: {until} tabşyrýarsyňyz. Nokatda garaşýarys — welosipedi zarýadly getiriň.',
    ...
    "CAB_BOOK_NO_MODELS": 'Model katalogy entek doldurylmady — bize ýazyň: {url}',
    "CAB_BOOK_NO_TARIFF": 'Bu model üçin entek baha ýok — bize ýazyň: {url}',
    "CAB_BOOK_STALE": 'Düwme köneldi, arzany täzeden başlaň.',
    "CAB_BOOK_CANCELLED": 'Arza aýryldy. Ýene gerek bolsa — düwme kabinetde.',
    "CAB_BOOK_REMOVED": 'Kärende arzasyny ({line}) operator aýyrdy.{note}\nSoraglar — bize ýazyň: {url}',
    "CAB_BOOK_LINE": '📝 Arza: {line}',
    "CAB_BOOK_OPT_MODEL": '{title} — boş {free}',
    "CAB_BOOK_OPT_MODEL_NONE": '{title} — nobata',
    "CAB_BOOK_OPT_TARIFF": '{name} — {price}',
    "CAB_BOOK_TODAY": 'Şu gün, {date}',
    "CAB_BOOK_TOMORROW": 'Ertir, {date}',
    "CAB_BOOK_DAY2": 'Birigün, {date}',
    "CAB_CLAIM_TOAST": 'Ýüztutma iberildi',
    "CAB_CLAIM_SENT": '✅ Ýüztutma operatora geçirildi. Töleg geçirilen badyna ýazaryn.\nÇegi şu ýere iberip bilersiňiz — ýüztutma goşaryn.',
    "CAB_CLAIM_EXISTS": 'Ýüztutma eýýäm operatorda barlanýar. Geçirilmegine garaşyň.',
    "CAB_RECEIPT_ATTACHED": 'Çek ýüztutma goşuldy.',
    "CAB_HISTORY": '🧾 <b>Amallaryň taryhy</b>\n\n{rows}',
    "CAB_HISTORY_EMPTY": 'Häzirlikçe amal ýok.',
    "CAB_KIND_PAYMENT": 'töleg',
    "CAB_KIND_CHARGE": 'hasaplama',
    "CAB_KIND_FINE": 'jerime / abatlaýyş',
    "CAB_KIND_REFUND": 'yzyna gaýtarmak',
    "CAB_KIND_ADJUST": 'düzediş',
    "CAB_KIND_BONUS": 'ballar',
    "CAB_CONTRACT_NONE": 'Şertnama entek resmileşdirilmedi. Botda gol çekilenden soň şu ýerde peýda bolar.',
    "CAB_CONTRACT_CAPTION": '📄 Siziň şertnamaňyz № {number}',
    "CAB_PAID_CONFIRMED": '✅ {amount} töleg geçirildi. Balans: {balance}.\n{rental}',
    "CAB_PAID_UNTIL": 'Tölenen möhlet: {until}.',
    "CAB_PAID_REJECTED": '❌ Operator tölegiňizi tapmady. Rekwizitleri barlaň we bize ýazyň: {url}',
    "CAB_REMIND_SOON": '📅 <b>{bike}</b> kärendesiniň tölenen döwri {until} gutarýar. Galan günler: {days}.\nBalansy {amount} möçberde dolduryň — kärende arakesmesiz dowam eder.',
    "CAB_REMIND_DUE": '📅 Şu gün <b>{bike}</b> kärendesi üçin töleg güni: {amount}.\nBalansy dolduryň — aşakdaky düwme.',
    "CAB_REMIND_OVERDUE": '⚠️ <b>{bike}</b> kärendesi {until} bäri tölenmedi. Bergi: {debt}.\nBalansy dolduryň ýa-da welosipedi tabşyryň — töleg hasaplanmagyny dowam edýär.',
    "CAB_RENTAL_OPENED": '🚲 Kärende resmileşdirildi: {bike}, «{tariff}» tarifi ({price} / {days} gün).\nTölenen möhlet: {until}. Balans: {balance}.',
    "CAB_RENTAL_CLOSED": '{bike} kärendesi ýapyldy. Balans: {balance}. Sag boluň!',
    "BTN_CAB_FRIENDS": '👥 Dostlarym',
    "BTN_CAB_REVIEW": '⭐ Teswir galdyr',
    "CAB_FRIENDS": '👥 <b>Dostlarym</b>\n\nÇakylyk kodyňyz: <code>{code}</code>\nSalgy: {link}\n\nOny welosiped gözleýän kuryere iberiň. Dostuňyz kärende resmileşdirip, ilkinji tölegi edende, balansyňyza <b>{bonus}</b> goşular.\n\n{stats}',
    "CAB_FRIENDS_STATS": 'Salgy boýunça geçenler: {click}\nHasaba duranlar: {signed}\nWelosiped alanlar: {rented}\nTöleg edenler: {paid}\nSize goşuldy: <b>{bonus}</b>',
    ...
    "BTN_CAB_CONTRACT": '📄 Şertnama',
    "BTN_CAB_REFRESH": '🔄 Täzelemek',
    "BTN_CAB_BACK": '◀️ Yza',
    "BTN_PAY_CHECK": '🔄 Tölegi barlamak',
    "BTN_BOOK": '🚲 Welosiped bronlamak',
