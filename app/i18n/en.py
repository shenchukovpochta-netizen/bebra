...
T: dict[str, str] = {
    ...
    # ── кабинет клиента (CRM) ──
    "CAB_UNAVAILABLE": 'The personal account is temporarily unavailable. Message us: ' + URL,
    "CAB_LINK_PROMPT": 'Hello! Tap the button below and I will link your account to the personal cabinet.',
    "CAB_NOT_FOUND": '⚠️ Your phone number was not found in the system.\nContact the manager: {url}',
    "CAB_LINKED": '✅ Account linked: {name}.',
    "CAB_BLOCKED": 'The personal cabinet is unavailable. Contact the manager: {url}',
    "CAB_HOME": '🚲 <b>My cabinet</b>\n\n👤 {name}\n💰 Balance: <b>{balance}</b>\n{rental}\n\n{hint}',
    "CAB_RENTAL": '🛵 Bike: {bike}\n📋 Plan: {tariff} — {price} / {days} days\n📅 Paid until: <b>{until}</b> ({left})',
    "CAB_NO_RENTAL": 'No active rental.',
    "CAB_LEFT_DAYS": 'days left: {days}',
    "CAB_LEFT_TODAY": 'payment due today',
    "CAB_OVERDUE": '⚠️ overdue by {days} days, debt {debt}',
    "CAB_HINT_DEBT": 'Top up the balance by {amount} so the rental continues without arrears.',
    "CAB_HINT_OK": 'You can top up in advance — the amount will cover the next period.',
    "CAB_PAY": '💳 <b>Top up the balance</b>\n\nSuggested amount: <b>{amount}</b>\nPay via the link (SBP): {pay_url}\n\nAfter the transfer tap “I have paid” — the operator will check the payment and credit it to your balance. You can send a receipt photo here.',
    "CAB_PAY_PICK": '💳 <b>Top up the balance</b>\n\nBalance: <b>{balance}</b>\n{hint}\n\nChoose an amount:',
    "CAB_PAY_NOTHING": 'No active rental and no debt — nothing to top up. Want a bike? Write to us: {url}',
    "CAB_PAY_STALE": 'The amount has changed, open the top-up again.',
    "CAB_PAY_ORDER": '💳 Invoice {no} for <b>{amount}</b>.\nPay via the button — the bank will send the receipt and the money lands on your balance within a minute.\nIf the button did not open: {link}',
    "CAB_PAY_PENDING": 'The bank has not confirmed the payment yet. Check again in a minute.',
    "CAB_PAY_DONE": '✅ Invoice {no} is paid: {amount} credited. Balance: {balance}.',
    "CAB_PAY_FAILED": 'Invoice {no} was closed without payment. Open the top-up again.',
    "CAB_OPT_DEBT": 'Debt — {amount}',
    "CAB_OPT_PERIOD": '{n} × {days} days — {amount}',
    "CAB_INTENT_RENEW": 'Noted: you are extending. We will remind you about the payment in advance.',
    "CAB_INTENT_RETURN": 'Noted: you return on {until}. See you at the point — please bring the bike charged.',
    ...
    "CAB_BOOK_NO_MODELS": 'The model catalogue is not filled in yet — write to us: {url}',
    "CAB_BOOK_NO_TARIFF": 'There is no price for this model yet — write to us: {url}',
    "CAB_BOOK_STALE": 'The button is outdated, start the request again.',
    "CAB_BOOK_CANCELLED": 'The request is withdrawn. Want one again — the button is in the cabinet.',
    "CAB_BOOK_REMOVED": 'Your rental request ({line}) was cancelled by the operator.{note}\nQuestions — write to us: {url}',
    "CAB_BOOK_LINE": '📝 Request: {line}',
    "CAB_BOOK_OPT_MODEL": '{title} — {free} free',
    "CAB_BOOK_OPT_MODEL_NONE": '{title} — waiting list',
    "CAB_BOOK_OPT_TARIFF": '{name} — {price}',
    "CAB_BOOK_TODAY": 'Today, {date}',
    "CAB_BOOK_TOMORROW": 'Tomorrow, {date}',
    "CAB_BOOK_DAY2": 'The day after tomorrow, {date}',
    "CAB_CLAIM_TOAST": 'Request sent',
    "CAB_CLAIM_SENT": '✅ The request has been passed to the operator. I will write as soon as the payment is credited.\nYou can send the receipt here — I will attach it to the request.',
    "CAB_CLAIM_EXISTS": 'Your request is already being checked by the operator. Please wait for the credit.',
    "CAB_RECEIPT_ATTACHED": 'The receipt is attached to the request.',
    "CAB_HISTORY": '🧾 <b>Transaction history</b>\n\n{rows}',
    "CAB_HISTORY_EMPTY": 'No transactions yet.',
    "CAB_KIND_PAYMENT": 'payment',
    "CAB_KIND_CHARGE": 'charge',
    "CAB_KIND_FINE": 'fine / repair',
    "CAB_KIND_REFUND": 'refund',
    "CAB_KIND_ADJUST": 'adjustment',
    "CAB_KIND_BONUS": 'bonus points',
    "CAB_CONTRACT_NONE": 'The agreement is not issued yet. It will appear here once signed in the bot.',
    "CAB_CONTRACT_CAPTION": '📄 Your agreement No. {number}',
    "CAB_PAID_CONFIRMED": '✅ Payment of {amount} credited. Balance: {balance}.\n{rental}',
    "CAB_PAID_UNTIL": 'Paid until: {until}.',
    "CAB_PAID_REJECTED": '❌ The operator could not find your payment. Check the details and message us: {url}',
    "CAB_REMIND_SOON": '📅 The paid period of your <b>{bike}</b> rental ends {until}. Days left: {days}.\nTop up the balance by {amount} — and the rental continues without a break.',
    "CAB_REMIND_DUE": '📅 Today is the payment day for the <b>{bike}</b> rental: {amount}.\nTop up the balance — the button below.',
    "CAB_REMIND_OVERDUE": '⚠️ The <b>{bike}</b> rental is unpaid since {until}. Debt: {debt}.\nPlease top up the balance or return the bike — the fee keeps accruing.',
    "CAB_RENTAL_OPENED": '🚲 Rental opened: {bike}, plan “{tariff}” ({price} / {days} days).\nPaid until: {until}. Balance: {balance}.',
    "CAB_RENTAL_CLOSED": 'The {bike} rental is closed. Balance: {balance}. Thank you!',
    "BTN_CAB_FRIENDS": '👥 My friends',
    "BTN_CAB_REVIEW": '⭐ Leave a review',
    "CAB_FRIENDS": '👥 <b>My friends</b>\n\nYour invite code: <code>{code}</code>\nLink: {link}\n\nSend it to a courier looking for a bike. Once your friend takes a rental and makes the first payment, <b>{bonus}</b> will be credited to your balance.\n\n{stats}',
    "CAB_FRIENDS_STATS": 'Followed the link: {click}\nRegistered: {signed}\nTook a bike: {rented}\nPaid: {paid}\nCredited to you: <b>{bonus}</b>',
    ...
    "BTN_CAB_CONTRACT": '📄 Agreement',
    "BTN_CAB_REFRESH": '🔄 Refresh',
    "BTN_CAB_BACK": '◀️ Back',
    "BTN_PAY_CHECK": '🔄 Check payment',
    "BTN_BOOK": '🚲 Book a bike',
